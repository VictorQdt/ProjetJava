...
public class InfosCours {
    ...
    /**
     * Fonction qui retourne une ArrayList contenant toutes les séances de
     * l'étudiant. Chaque séance est elle même une ArrayList qui contient :
    ...
    public ArrayList<Object> rechercheCoursEtudiant(int idEtudiant) throws SQLException {
        ...
        for (int i = 0; i < listeSeances.size(); i++) {
            ...
            listeInfos.add(coursDAO.find(seance.getId_cours()));
    ...
    public ArrayList<Object> rechercheCoursProf(int idProf) throws SQLException {
        ...
        Seance_enseignantsDAO seancesenseignantsDAO = new Seance_enseignantsDAO(connect);
        listeSeances = seancesenseignantsDAO.findSeances(idProf);
